      ...
      <DialogContent className="bg-slate-50 text-black p-0 overflow-hidden rounded-lg">
        <DialogHeader className="pt-10 px-8">
          ...
          <DialogDescription className="text-md text-center p-2">
            Are you sure you want to delete <span className="font-semibold text-black">{server?.name}</span> ???
            <p><span className="font-semibold text-black">{server?.name}</span> will be permanently deleted!</p>
          </DialogDescription>
        </DialogHeader>
