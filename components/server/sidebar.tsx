...
import { Text, Mic, Video, ShieldCheck, Lock } from "lucide-react";
...
const roleIconMap = {
  ...
  [MemberRole.ADMIN]: <Lock className="mr-2 h-4 w-4" />,
  [MemberRole.MEDIATOR]: <ShieldCheck className="mr-2 h-4 w-4" />,
};
...
export const ServerSidebar = async ({ serverId }: ServerSidebarProps) => {
  ...
  return (
    <div className="flex flex-col h-full text-primary w-full bg-gray-200 dark:bg-slate-800">
      ...
      <ScrollArea className="flex-1 px-3">
        ...
        <Separator className="bg-zinc-300 dark:bg-zinc-700 rounded-sm my-2" />
        {!!textChannels?.length && (
          <div className="mb-3">
            <ServerSection
